...
{
    [DataContract]
    public class NexusOptionsOld
    {
        public NexusOptionsOld()
        {
            // unset, mutable
        ...
        public static NexusOptionsOld Load(string filePath)
        {
            var jsonString = File.ReadAllText(filePath);
            var options = new JsonSerializerOptions();
            options.Converters.Add(new TimeSpanConverter());

            return JsonSerializer.Deserialize<NexusOptionsOld>(jsonString, options);
        }
