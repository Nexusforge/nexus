...
namespace Nexus.Extensibility.Tests
{
    public class PipeDataSourceTests
    {
        ...
        public PipeDataSourceTests(ITestOutputHelper xunitLogger)
        {
            _logger = new XunitLoggerProvider(xunitLogger).CreateLogger(nameof(PipeDataSourceTests));
        }
        ...
        public async Task ProvidesCatalog()
        {
            ...
            {
                ResourceLocator = new Uri(Path.Combine(Directory.GetCurrentDirectory(), "DATABASES/A")),
                Logger = _logger,
        ...
        public async Task CanProvideTimeRange()
        {
            ...
            var expectedEnd = new DateTime(2020, 01, 02, 00, 20, 00, DateTimeKind.Utc);
